    ...
    >
      <div className="__leftSection h-full w-full md:w-[65%] flex justify-center flex-col">
        ...
        <div className="flex justify-start items-center mt-10">
            <a target="_blank" href="https://drive.google.com/file/d/1P4nZJoOLqz_J9e3SpPUbYFRVnrc50443/view?usp=sharing" className="bg-[#7616cf] transition-all ease-in-out duration-300 hover:scale-105 hover:bg-[#5909a5] font-medium text-sm md:text-lg px-4 py-2 rounded-full">Check Resume</a>
        </div>
      </div>
